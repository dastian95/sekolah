...
<div class="container-lg py-4" style="max-width: 720px;">
    ...
    <div class="mb-4">
        ...
        <h4 class="fw-bold mt-2 mb-0" style="color: var(--dark-blue);">
            <i class="fas fa-edit me-2"></i>Edit Kemitraan
        </h4>
    </div>
            ...
            <form method="POST" action="{{ route('admin.partnerships.update', $partnership) }}" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    @if($partnership->file_path)
                        <div class="mb-2">
                            <a href="{{ asset('storage/'.$partnership->file_path) }}" target="_blank"
                ...
                <div class="row g-3 mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="number" name="sort_order" class="form-control @error('sort_order') is-invalid @enderror"
                               value="{{ old('sort_order', $partnership->sort_order) }}" min="0">
