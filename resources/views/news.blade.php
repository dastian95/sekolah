...
@section('title', 'Berita & Artikel - Labitech Insan Mulia')
...
<section style="background: linear-gradient(135deg, var(--dark-blue) 0%, #2d5a8c 100%); color: white; padding: 3rem 0;">
    <div class="container-lg">
        ...
        <p style="margin-top: 0.5rem; font-size: 1.1rem; opacity: 0.9;">Informasi terkini dari SDIT Labitech Insan Mulia</p>
    </div>
</section>
        ...
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="news-card" style="margin-bottom: 0;">
                    ...
                    @else
                        <img src="https://via.placeholder.com/800x400?text={{ urlencode($featured->title) }}" alt="{{ $featured->title }}" style="height: 400px;">
                    @endif
                    <div class="news-card-body">
                        <div class="news-card-title" style="font-size: 1.5rem;">{{ $featured->title }}</div>
                        <div class="news-card-date">{{ $featured->published_at->format('d F Y') }}</div>
                ...
                <div style="background-color: #f8f9fa; padding: 1.5rem; border-radius: 8px;">
                    ...
                    <div style="border-bottom: 1px solid #e0e0e0; padding-bottom: 1rem; margin-bottom: 1rem;">
                        <h4 style="margin: 0 0 0.5rem 0; color: var(--dark-blue); font-weight: 600; font-size: 0.95rem;">
                            <a href="#" style="color: inherit; text-decoration: none;">Pendaftaran Siswa Baru SDIT Labitech 2026 Dibuka</a>
                        </h4>
                        <div style="font-size: 0.85rem; color: #999;">13 Februari 2026</div>
                    </div>
                    <div style="border-bottom: 1px solid #e0e0e0; padding-bottom: 1rem; margin-bottom: 1rem;">
                        <h4 style="margin: 0 0 0.5rem 0; color: var(--dark-blue); font-weight: 600; font-size: 0.95rem;">
                            <a href="#" style="color: inherit; text-decoration: none;">Prestasi Siswa SDIT Labitech dalam Kompetisi Sains</a>
                        </h4>
            ...
            @forelse($news as $item)
                <div class="col-md-6 col-lg-4">
                    <div class="news-card">
                        ...
                        @else
                            <img src="https://via.placeholder.com/400x300?text={{ urlencode($item->title) }}" alt="{{ $item->title }}">
                        @endif
                        <div class="news-card-body">
                            <div class="news-card-title">{{ $item->title }}</div>
                            <div class="news-card-date">{{ $item->published_at->format('d F Y') }}</div>
