...
<head>
    ...
    <style>
        ...
        * { font-family: 'Poppins', sans-serif; }
        ...
        .navbar-website .btn-admin-panel {
        ...
        .navbar-website .btn-admin-panel:hover {
            background: #ffb700;
            transform: translateY(-1px);
            box-shadow: 0 4px 12px rgba(255,215,0,0.3);
        }

        /* ===== NAVBAR 2: Admin Bar (Bottom) ===== */
        .navbar-admin-bar {
        ...
        .admin-nav-items .admin-nav-link {
            display: flex;
            align-items: center;
            gap: 0.4rem;
        ...
        .admin-nav-items .admin-nav-link:hover {
            color: white;
            background: rgba(255,255,255,0.05);
        }

        .admin-nav-items .admin-nav-link.active {
        ...
        .admin-nav-items .admin-nav-link i {
            font-size: 0.85rem;
        }

        /* Admin bar right side */
        .admin-bar-right {
            display: flex;
            align-items: center;
            gap: 0.75rem;
        ...
        .admin-bar-right .admin-user {
            color: rgba(255,255,255,0.6);
            font-size: 0.75rem;
            white-space: nowrap;
        }

        .admin-bar-right .btn-logout {
        ...
        .admin-bar-right .btn-logout:hover {
            background: #dc3545;
            border-color: #dc3545;
            color: white;
        }

        /* Admin dropdown in admin bar */
        .admin-nav-items .dropdown-menu {
            border: none;
            box-shadow: 0 8px 25px rgba(0,0,0,0.15);
            border-radius: 8px;
            padding: 0.4rem 0;
        ...
        .admin-nav-items .dropdown-item {
            font-size: 0.85rem;
            padding: 0.45rem 1rem;
            transition: all 0.2s;
        }

        .admin-nav-items .dropdown-item:hover {
            background: #f0f7ff;
            color: var(--primary-blue);
        }

        .admin-nav-items .dropdown-item.active {
            background: var(--primary-blue);
            color: white;
        }

        /* Mobile admin bar toggle */
        .admin-bar-toggle {
            display: none;
            background: none;
            border: none;
        ...
        .admin-bar-toggle:hover { color: var(--secondary-yellow); }
        ...
        @media (max-width: 991px) {
            .admin-bar-toggle { display: block; }
...
<body>
            ...
            <div class="collapse navbar-collapse" id="websiteNav">
                <ul class="navbar-nav ms-auto align-items-center">
                    ...
                    <li class="nav-item ms-lg-2">
                        <a class="btn btn-admin-panel" href="{{ route('admin.dashboard') }}">
    ...
    {{-- ===== NAVBAR 2: Admin Navigation Bar ===== --}}
    <nav class="navbar-admin-bar">
        <div class="container-lg">
            <button class="admin-bar-toggle" onclick="document.getElementById('adminNavItems').classList.toggle('show')">
                <i class="fas fa-bars me-1"></i> Menu Admin
            </button>

            <ul class="admin-nav-items" id="adminNavItems">
                <li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><hr class="dropdown-divider"></li>
                        <li><a class="dropdown-item {{ request()->routeIs('admin.settings.about') ? 'active' : '' }}" href="{{ route('admin.settings.about') }}"><i class="fas fa-info-circle me-2"></i> Tentang Kami</a></li>
                        <li><a class="dropdown-item {{ request()->routeIs('admin.settings.contact') ? 'active' : '' }}" href="{{ route('admin.settings.contact') }}"><i class="fas fa-address-book me-2"></i> Kontak</a></li>
                    </ul>
                </li>
            </ul>
